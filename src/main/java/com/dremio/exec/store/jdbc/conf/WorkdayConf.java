...
@SourceType(value = "WorkdayARP", label = "Workday",uiConfig = "workday-layout.json")
public class WorkdayConf extends AbstractArpConf<WorkdayConf> {
  private static final String ARP_FILENAME = "arp/implementation/workday-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.workday.WorkdayDriver";
